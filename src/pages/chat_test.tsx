          ...
          <Grid container component={Paper} className={classes.chatSection}>
            <Grid item xs={3} className={classes.borderRight500}>
              ...
              <List>
                <ListItem button key="RemySharp">
                  <ListItemIcon>
                    <Avatar alt="Remy Sharp" src="https://res.cloudinary.com/doalzf6o2/image/upload/v1637293473/cfvjlpucg5eoq5pc0hjz.png" />
                  </ListItemIcon>
                ...
                <ListItem button key="Alice">
                  <ListItemIcon>
                    <Avatar alt="Alice" src="https://res.cloudinary.com/doalzf6o2/image/upload/v1637495562/NicePng_harambe-face-png_1866063_kfrevi.png" />
                  </ListItemIcon>
                  <ListItemText primary="Alice">Alice</ListItemText>
                </ListItem>
                <ListItem button key="CindyBaker">
                  <ListItemIcon>
                    <Avatar alt="Cindy Baker" src="https://res.cloudinary.com/doalzf6o2/image/upload/v1637106685/hero-image_vzhsrd.png" />
                  </ListItemIcon>
