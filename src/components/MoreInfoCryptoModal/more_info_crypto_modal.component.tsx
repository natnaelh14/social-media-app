        ...
        <Dialog open={open} onClose={handleClose} fullWidth maxWidth="sm">
            ...
            <DialogContent style={{ height: "550px" }}>
                ...
                <Box>
                    ...
                    <Typography fontFamily='inherit' mb='0.75rem' sx={{ fontSize: "15px" }}><b>WHITE PAPER:</b> <a target="_blank" style={{ textDecoration: "none" }} href={coinWhitePaper} rel="noreferrer">{coinWhitePaper}</a></Typography>
